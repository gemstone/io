...
namespace Gemstone.IO.Collections
{
    ...
    public sealed class FileBackedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDisposable where TKey : notnull
    {
        ...
        // Fields
        private readonly FileBackedLookupTable<TKey, TValue> m_lookupTable;
        ...
        public FileBackedDictionary()
            : this((IEqualityComparer<TKey>?)default)
        {
        }
        ...
        public FileBackedDictionary(string filePath)
            : this(filePath, (IEqualityComparer<TKey>?)default)
        {
        }
        ...
        /// </summary>
        public byte[] DefaultSignature => new Guid(FileBackedLookupTable<TKey, TValue>.DictionarySignature).ToRfcBytes();
        ...
        {
            get => m_lookupTable[key];
            set => m_lookupTable[key] = value;
        }
        ...
        /// </returns>
        public ICollection<TValue> Values => GetValues().ToList();
        ...
        /// <exception cref="ArgumentNullException"><paramref name="key"/> is null.</exception>
        public bool ContainsKey(TKey key) => m_lookupTable.ContainsKey(key);
        ...
        public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator() => m_lookupTable.GetEnumerator();
        ...
        public IEnumerable<TKey> GetKeys() => m_lookupTable.GetKeys();
        ...
        public IEnumerable<TValue> GetValues() => this.Select(kvp => kvp.Value);
