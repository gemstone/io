...
namespace Gemstone.IO
{
    ...
    public class SafeFileWatcher : IDisposable
    {
        ...
        public WaitForChangedResult WaitForChanged(WatcherChangeTypes changeType, int timeout) => m_fileSystemWatcher.WaitForChanged(changeType, timeout);
        ...
        /// </summary>
        public void BeginInit() => m_fileSystemWatcher.BeginInit();
