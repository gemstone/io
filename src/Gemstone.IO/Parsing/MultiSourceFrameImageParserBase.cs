...
namespace Gemstone.IO.Parsing
{
    ...
    public abstract class MultiSourceFrameImageParserBase<TSourceIdentifier, TTypeIdentifier, TOutputType> : FrameImageParserBase<TTypeIdentifier, TOutputType> where TTypeIdentifier : notnull where TOutputType : ISupportSourceIdentifiableFrameImage<TSourceIdentifier, TTypeIdentifier> where TSourceIdentifier : notnull
    {
        #region [ Members ]
        ...
        public class SourceIdentifiableBuffer
        {
            ...
            /// </summary>
            public TSourceIdentifier Source = default!;
        ...
        private TSourceIdentifier m_source = default!;
        ...
        /// <param name="count">An <see cref="int"/> for the offset.</param>
        /// <param name="offset">An <see cref="int"/> for the count.</param>
        [EditorBrowsable(EditorBrowsableState.Never), Obsolete("MultiSourceFrameImageParserBase requires consumers call Parse overload that takes data source identifier as an argument", true)]
